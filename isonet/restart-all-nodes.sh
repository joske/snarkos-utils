#!/bin/bash
NODES="snarkos-client-val0-client0 snarkos-client-val0-client1 snarkos-client-val0-client2 snarkos-client-val1-client0 snarkos-client-val1-client1 snarkos-client-val1-client2 snarkos-client-val2-client0 snarkos-client-val2-client1 snarkos-client-val2-client2 snarkos-client-val3-client0 snarkos-client-val3-client1 snarkos-client-val3-client2 snarkos-client-val4-client0 snarkos-client-val4-client1 snarkos-client-val4-client2 snarkos-client-val5-client0 snarkos-client-val5-client1 snarkos-client-val5-client2 snarkos-client-val6-client0 snarkos-client-val6-client1 snarkos-client-val6-client2 snarkos-client-val7-client0 snarkos-client-val7-client1 snarkos-client-val7-client2 snarkos-client-val8-client0 snarkos-client-val8-client1 snarkos-client-val8-client2 snarkos-node-0 snarkos-node-1 snarkos-node-2 snarkos-node-3 snarkos-node-4 snarkos-node-5 snarkos-node-6 snarkos-node-7 snarkos-node-8 snarkos-node-9"
